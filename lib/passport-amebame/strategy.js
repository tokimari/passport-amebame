...
Strategy.prototype.authorizationParams = function (options) {
  ...
  console.info('Strategy.authorizationParams', params);
  return params;
};
...
Strategy.prototype.userProfile = function (accessToken, done) {
  ...
  this._oauth2.get(this._profileUrl, accessToken, function (err, body) {
    if (err) {
      console.info('Strategy.userProfile.err:', err);
      console.info('Strategy.userProfile.err.summary:', err.StatusCode, err.code, err.name, err.message);
